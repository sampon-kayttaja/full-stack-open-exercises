  ...
  describe('when logged in', () => {
    ...
    describe('and a blog exists', () => {
      ...
      test('liking a blog works', async ({ page }) => {
        ...
        await page.getByText('The Added Blog by Test Author').click()
      ...
      test('blog can be removed', async ({ page }) => {
        ...
        await expect(page.getByText('The Added Blog by Test Author')).not.toBeVisible()
      })
    ...
    describe('multiple blogs', () => {
      beforeEach(async ({ page }) => {
        ...
        await page.getByText('Blog With 1 Like').click()
        ...
        await page.getByText('Blog With 2 Likes').click()
